...
The engine performs 2,448 PRNG calls to generate the initial state (St:12 Dx:14 Co:12 In:15 Wi:12). Wizard begins on Dungeon Level 1 and declines the tutorial. The character's initial attributes are configured as (St:12 Dx:14 Co:12 In:15 Wi:12 Ch:10).
