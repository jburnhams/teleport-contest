...
The engine performs 2,722 PRNG calls to generate the initial state (St:12 Dx:12 Co:13 In:18 Wi:12). Merlin begins on Dungeon Level 1, armed with his starting magical arsenal. The character's initial attributes are configured as (St:12 Dx:12 Co:13 In:18 Wi:12 Ch:8).
