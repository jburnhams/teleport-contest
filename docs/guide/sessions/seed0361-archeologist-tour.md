...
The engine performs 2,922 PRNG calls to generate the initial state for a neutral human Archeologist (St:10 Dx:11 Co:11 In:15 Wi:18). Wizard begins on Dungeon Level 1 and declines the tutorial. The character's initial attributes are configured as (St:10 Dx:11 Co:11 In:15 Wi:18 Ch:10).
