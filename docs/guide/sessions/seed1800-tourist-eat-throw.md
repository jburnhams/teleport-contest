...
The engine performs 2,360 PRNG calls to generate the universe and Touristo's attributes (St:15 Dx:10 Co:15 In:11 Wi:8). Touristo begins on Dungeon Level 1 as an unproven `@`, armed with a starting inventory of food and darts.
