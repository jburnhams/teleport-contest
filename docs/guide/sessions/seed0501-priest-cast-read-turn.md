...
The engine performs 2,203 PRNG calls to generate the initial state (St:13 Dx:12 Co:13 In:10 Wi:18). Clara begins on Dungeon Level 1 and declines the tutorial. The character's initial attributes are configured as (St:13 Dx:12 Co:13 In:10 Wi:18 Ch:9).
