...
The engine performs 2,776 PRNG calls to generate the initial state (St:14 Dx:9 Co:12 In:7 Wi:14 Ch:17). The initialisation logic detects the "New Moon" condition from the system clock and applies the deterministic luck penalty: *Be careful! New moon tonight.*
