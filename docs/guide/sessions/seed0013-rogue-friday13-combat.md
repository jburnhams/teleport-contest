...
The engine performs exactly 3,824 PRNG calls to seed the universe, immediately noticing the local system clock and outputting the twin astrological warnings: *You are lucky! Full moon tonight.* and *Watch out! Bad things can happen on Friday the 13th.* Sneaky wanders around the starting room (`L, l, J, K...`), testing line-of-sight and basic locomotion. The character's initial attributes are configured as (St:14 Dx:16 Co:14 In:10 Wi:12 Ch:9).
