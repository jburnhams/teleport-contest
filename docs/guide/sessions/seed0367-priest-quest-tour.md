...
The engine performs 1,846 PRNG calls to generate the initial state for a chaotic human Priestess (St:9 Dx:15 Co:9 In:11 Wi:17). Wizard, represented by the `@` symbol, begins on Dungeon Level 1 and declines the tutorial.
...
- Step 309: She attempts to move a boulder (`0`): *You try to move the boulder, but in vain.*
