...
The engine performs 1,846 PRNG calls to generate the initial state for a chaotic human Priestess (St:9 Dx:15 Co:9 In:11 Wi:17). Wizard begins on Dungeon Level 1 and declines the tutorial. The character's initial attributes are configured as (St:9 Dx:15 Co:9 In:11 Wi:17 Ch:14).
