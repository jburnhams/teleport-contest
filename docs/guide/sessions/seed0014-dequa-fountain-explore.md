...
Dequa (St:18/02 Dx:12 Co:18 In:8 Wi:9 Ch:8) is created through a sequence of manual menu selections (`v` for Valkyrie, `d` for Dwarf). The engine calculates her impressive Strength (18/02) and Constitution (18) across 2,953 PRNG calls. Upon materialising, she is greeted by the light of a Full Moon, granting her a deterministic luck bonus.
