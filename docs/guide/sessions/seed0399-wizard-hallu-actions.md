...
The engine performs 2,783 PRNG calls to generate the initial state (St:11 Dx:11 Co:12 In:18 Wi:15). Wizard begins on Dungeon Level 1 and declines the tutorial. The character's initial attributes are configured as (St:11 Dx:11 Co:12 In:18 Wi:15 Ch:8).
