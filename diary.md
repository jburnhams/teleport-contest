...
### Stream F: Further Hero Init (Skills & Invent)
...
### Stream A Task Review & Verification
...
- Corrected/confirmed missing object class constants (`WEAPON_CLASS`, etc.) in `js/const.js`.
...
- **Next steps**: Begin work on Stream D (Object System) or Stream E (Monster System) since Stream A dependencies are met (investigating `mksobj_init` logic).

### Stream E: mondata.js helpers
