...
## 2026-05-21
- Completed Stream F2 sub-tasks: ported `knows_object()`, `knows_class()`, and inventory equipment logic (`uwep`, `uarm`, etc.).
- Verified equipment mask properties and linked starting items to the hero's inventory accurately using `set_invent`.
- Maintained perfect baseline scoring (88/11406 screens) after integrating new logic.
- What's next: Begin F3 or F4 to finish out Stream F character and attribute logic.
