...
- **Next steps**: Begin Stream D (Object System / Creation) investigating `mksobj_init` logic (~200 lines) or Stream E (Monster System) since Stream A dependencies are met.
