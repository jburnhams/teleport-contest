...
## 2026-05-16
- Continued Stream C (C2).
- Ported `putmsghistory()` functionality to `js/pline.js`, simply pushing into `game.nhDisplay.messages` directly as directed.
- Verified unit test coverage for `putmsghistory`.
- Achieved +0 regression score (88/11406 screens baseline).
- Next step: Stream C3 (Map rendering improvements).
