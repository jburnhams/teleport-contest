...
- Corrected/added missing object class constants (`WEAPON_CLASS`, etc.) in `js/const.js`.
...
- Next steps: Begin Stream D (Object System) or Stream E (Monster System) since Stream A dependencies are met (investigating `mksobj_init` logic ~200 lines).
