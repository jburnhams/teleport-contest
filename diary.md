...
- Stream D by completing subtask D2.2 (Probability helpers / `rnd_class`).
...
- Stream E, ticking subtask E2 (mondata.js — data helpers).
...
- Stream D by beginning D2.1: BUC assignment logic (`bcsign`, `curse`, `bless`, `blessorcurse`, `uncurse`).
