...
**Your job this session:** Make small, steady progress on **Stream A** from `tasks/A-data-tables.md`. Work one sub-task at a time, verifying after each before moving on.
...
1. `tasks/A-data-tables.md` — your task checklist for this stream
...
For each checklist item in `tasks/A-data-tables.md`:
...
5. **Tick the checklist** — edit `tasks/A-data-tables.md` and mark the item `[x]`.
...
Read `tasks/A-data-tables.md` now and identify:
