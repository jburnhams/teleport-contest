...
describe('pline', () => {
    ...
    it('should push to history without displaying in putmsghistory', () => {
        game.nhDisplay = new GameDisplay(null);
        putmsghistory("History message");
        expect(game.nhDisplay.messages).toContain("History message");
        expect(game.nhDisplay.topMessage).toBeNull(); // Should not display it
    });
});
